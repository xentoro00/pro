          ...
          <form action="" onSubmit={handleSubmit}>           
             ...
             <p>If you have any work from me or any types of queries related to my tutorial, you can send me a message from here. It's my pleasure to help you.</p>
              <div className="input-box">
                <input type="text"  name='name' className="form-control form-control-lg" placeholder="Your first name"
                onChange={handeInput}  />
              ...
              <div className="input-box">
                <input type="email"  name='email' className="form-control form-control-lg" style={{ paddingLeft: '2.5rem', paddingRight: '2.5rem' }} placeholder="Enter a valid email address" 
                   onChange={handeInput}  />
              ...
              <input type="text"  name='message' className="form-control form-control-lg" placeholder="Message"
                onChange={handeInput}  />
