          ...
          <form action="" onSubmit={handleSubmit}>           
             <div className="h1">Register</div> <br />
              <div className="form-outline mb-4 d-flex">
                <input type="text" id="form3Example3" name='name' className="form-control form-control-lg" placeholder="Your first name"
                onChange={handeInput}  />
                {errors.name && <span className='text-danger'> {errors.name}</span>} 
                
                <input type="text" id="form3Example3" name='lastname' className="form-control form-control-lg" placeholder="Your last name"
                onChange={handeInput}  />
